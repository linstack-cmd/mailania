...
export function DetailScreen({
  ...
  return (
    ...
    >
      ...
      {/* Action buttons - desktop and tablet in footer, mobile in sticky bottom bar */}
      <div
        className={css((t) => ({
          display: "flex",
          gap: t.spacing(2),
          ...
          "@media (max-width: 640px)": {
            ...
            left: 0,
            right: 0,
            padding: `${t.spacing(2)} ${t.spacing(2)} calc(${t.spacing(2)} + env(safe-area-inset-bottom, 0px))`,
            background: "rgba(255, 255, 255, 0.32)",
            backdropFilter: "blur(14px) saturate(1.4)",
            borderTop: "1px solid rgba(255, 255, 255, 0.3)",
            zIndex: 40,
